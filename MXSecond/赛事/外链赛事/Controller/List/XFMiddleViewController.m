...
@interface XFMiddleViewController ()<UITableViewDataSource, UITableViewDelegate, RefreshTableViewDelegate>
{
    NSInteger _page;
}
...
@implementation XFMiddleViewController
...
- (void)refreshTableViewFooter {
    ...
    [[WebManager sharedManager] getMatchListWithClassId:7 pageIndex:_page success:^(NSArray *resultArr, NSString *msg) {
