...
@interface LJMatchGoalModel : NSObject
...
//@property (nonatomic, assign) NSInteger assist_count;/**< <#注释#> */
@property (nonatomic, assign) NSInteger pen_goal_count;/**< 点球 */
...
@property (nonatomic, assign) NSInteger goal_count;/**< 进球 */
@end
