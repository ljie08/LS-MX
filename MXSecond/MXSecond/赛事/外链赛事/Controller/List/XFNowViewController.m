...
@interface XFNowViewController ()<UITableViewDataSource, UITableViewDelegate, RefreshTableViewDelegate>
{
    NSInteger _page;
}
...
@implementation XFNowViewController
...
- (void)refreshTableViewFooter {
    ...
    [[WebManager sharedManager] getMatchListWithClassId:0 pageIndex:_page success:^(NSArray *resultArr, NSString *msg) {
