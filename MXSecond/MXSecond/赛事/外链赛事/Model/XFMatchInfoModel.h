...
#import "XFVSEventModel.h"
@interface XFMatchInfoModel : NSObject
...
@property (nonatomic , strong) XFVSEventModel * awayVs ;//客队战绩
...
@property (nonatomic , strong) XFVSEventModel * homeVs ;
...
@property (nonatomic , strong) XFVSEventModel * vs ;//主客队历史交战
