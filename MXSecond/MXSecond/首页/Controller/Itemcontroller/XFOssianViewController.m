...
@interface XFOssianViewController ()<UITableViewDataSource, UITableViewDelegate, RefreshTableViewDelegate>
{
    NSInteger _page;
}
...
@implementation XFOssianViewController
...
- (void)refreshTableViewFooter {
    ...
    [[WebManager sharedManager] getNewListWithClassId:56 pageIndex:_page type:1 success:^(NSArray *resultArr, NSString *msg) {
